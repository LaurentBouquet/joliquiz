...
task('import', function () {
    ...
    run('cd {{release_path}}; psql --file initial-prod-data-languages.pgsql.sql '.$DATABASE_URL. ';');
    run('cd {{release_path}}; psql --file initial-prod-data-users.pgsql.sql '.$DATABASE_URL. ';');
    // run('cd {{release_path}}; psql --file initial-prod-data-exemples.pgsql.sql '.$DATABASE_URL. ';');
});
