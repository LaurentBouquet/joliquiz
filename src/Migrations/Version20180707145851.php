...
final class Version20180707145851 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tbl_history_question (id INT NOT NULL, workout_id INT NOT NULL, date_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, question_id INT NOT NULL, question_text TEXT NOT NULL, completed BOOLEAN NOT NULL, question_success BOOLEAN DEFAULT NULL, duration CHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tbl_history_answer (id INT NOT NULL, question_history_id INT NOT NULL, date_time TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, answer_id INT NOT NULL, answer_text TEXT NOT NULL, answer_correct BOOLEAN NOT NULL, correct_given BOOLEAN NOT NULL, answer_succes BOOLEAN NOT NULL, PRIMARY KEY(id))');
