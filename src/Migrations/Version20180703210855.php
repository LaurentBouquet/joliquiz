 ...
 */
final class Version20180703210855 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_question DROP multiple');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER SEQUENCE tbl_quiz_id_seq INCREMENT BY 1');
        $this->addSql('ALTER SEQUENCE tbl_user_id_seq INCREMENT BY 1');
        $this->addSql('ALTER TABLE tbl_question ADD multiple BOOLEAN NOT NULL');
    }
}
