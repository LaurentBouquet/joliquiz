 ...
 */
final class Version20230214152906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tbl_language (id INT AUTO_INCREMENT NOT NULL, english_name VARCHAR(50) NOT NULL, native_name VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_83E89798734D08E1 (english_name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tbl_question (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, language_id INT NOT NULL, text LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, max_duration INT DEFAULT NULL, INDEX IDX_E1C4AF63B03A8386 (created_by_id), INDEX IDX_E1C4AF6382F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
