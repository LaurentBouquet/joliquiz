 ...
 */
final class Version20200404222408 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tbl_category (id INT NOT NULL, language_id VARCHAR(2) NOT NULL, shortname VARCHAR(50) NOT NULL, longname VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_517FFFEC82F1BAF4 ON tbl_category (language_id)');
        $this->addSql('CREATE TABLE tbl_question (id INT NOT NULL, language_id VARCHAR(2) NOT NULL, text TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tbl_user (id INT NOT NULL, prefered_language_id VARCHAR(2) DEFAULT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(64) NOT NULL, is_active BOOLEAN NOT NULL, roles TEXT NOT NULL, password_requested_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tbl_quiz (id INT NOT NULL, language_id VARCHAR(2) NOT NULL, title VARCHAR(255) NOT NULL, summary TEXT DEFAULT NULL, number_of_questions INT NOT NULL, active BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, show_result_question BOOLEAN NOT NULL, show_result_quiz BOOLEAN NOT NULL, allow_anonymous_workout BOOLEAN NOT NULL, result_quiz_comment TEXT DEFAULT NULL, start_quiz_comment TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tbl_workout (id INT NOT NULL, student_id INT NOT NULL, quiz_id INT NOT NULL, started_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, ended_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, number_of_questions INT NOT NULL, completed BOOLEAN NOT NULL, score DOUBLE PRECISION DEFAULT NULL, comment TEXT DEFAULT NULL, PRIMARY KEY(id))');
