 ...
 */
final class Version20180707165454 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tbl_quiz ADD show_result_question BOOLEAN NOT NULL');
        $this->addSql('ALTER TABLE tbl_quiz ADD show_result_quiz BOOLEAN NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER SEQUENCE tbl_history_question_id_seq INCREMENT BY 1');
        $this->addSql('ALTER SEQUENCE tbl_history_answer_id_seq INCREMENT BY 1');
        $this->addSql('ALTER TABLE tbl_quiz DROP show_result_question');
        $this->addSql('ALTER TABLE tbl_quiz DROP show_result_quiz');
    }
}
